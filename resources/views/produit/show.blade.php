        ...
        <div class=" py-8">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col md:flex-row  bg-[#8AD9D7] -mx-4 p-10 rounded-2xl">
                            ...
                            <div class="w-1/2 px-2">
                                <form action="stripe/test" method="POST">
                                    ...
                                    <button type="submit" id="checkout-test-button"
                                        class="w-full bg-gray-900 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800 dark:hover:bg-gray-700">Checkout
                                        (Test)</button>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="md:flex-1 px-4">
                        <h2 class="text-2xl font-bold dark:text-white mb-2">{{ $produit->titre }}</h2>
                        <div class="flex mb-4">
                            <div class="mr-4">
                                <span class="font-bold dark:text-gray-300">Price:</span>
                                <span class="dark:text-gray-300">{{ $produit->prix }}</span>
                            </div>
                            <div>
                                <span class="font-bold dark:text-gray-300">Availability:</span>
                                <span
                                    class="text-gray-600 ">{{ $produit->quantite < 1 ? 'Out of Stock' : 'In Stock' }}</span>
                            </div>
                        </div>
                        <div class="mb-4">
                            <span class="font-bold dark:text-gray-300">Select Size:</span>
