...
<body>
    <section>
        <div class=" bg-[#231F52] relative overflow-hidden h-screen">
            <header class="h-24 sm:h-32 flex items-center z-30 w-full">
                <div class="container mx-auto px-6 flex items-center justify-between">
                    <div class="uppercase text-[#FF7755] font-black text-5xl underline">
                        Super Clothes
                    </div>
                    <div class="flex items-center">
                        <nav class="font-sen text-[#F2C749] front-bold uppercase text-lg lg:flex items-center hidden">
            ...
            <div class="bg-[#231F52] flex relative z-20 items-center overflow-hidden">
                <div class="container mx-auto px-6 flex relative py-16">
                    <div class="sm:w-2/3 lg:w-2/5 flex flex-col relative z-20  justify-center">

                        <h1
                            class="font-bebas-neue uppercase text-6xl sm:text-4xl font-black flex flex-col leading-none text-[#8AD9D7]">
                            Habillez-vous pour la job que vous voulez!
                        </h1>
                        <p class="text-sm sm:text-base text-[#F2C749]  ">
            ...
            @foreach ($produits as $produit)
                ...
                <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
                    <a href="{{ route('produit.show', ['produit' => $produit->id]) }}">
                        <img src="{{ Vite::asset('storage/app/public/' . $produit->photo) }}" alt="Product"
                            class="h-80 w-72 object-cover rounded-t-xl" />
                        <div class="px-4 py-3 w-72">

                            <p class="text-lg font-bold text-black truncate block capitalize">{{ $produit->titre }}</p>
                            <div class="flex items-center">
                                <p class="text-lg font-semibold text-black cursor-auto my-3">{{ $produit->prix }}$</p>
                                {{-- <del>
    ...
    <div class="text-center bg-[#FF7755] w-4/5 mx-auto rounded-2xl"">
        ...
        <span class="block text-sm text-center text-gray-500">
            <a href="https://flowbite.com" class="text-purple-600 hover:underline">Super Clothes ©</a>
            <a href="https://tailwindcss.com" class="text-purple-600 hover:underline">- Tous droits réservés
            </a>.
        </span>
